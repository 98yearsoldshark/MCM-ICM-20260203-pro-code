# -*- coding: utf-8 -*-
# XGBoost：可选依赖（xgboost），提供统一 solve 接口
...
def solve(data: Any, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    """
    统一接口：XGBoost 训练与评估（分类/回归）。

    说明：该模块依赖 `xgboost`，未安装时会给出安装提示。
    ...
    Args:
        ...
        params: 参数：
            ...
            - model_params: dict（传给 XGBClassifier/XGBRegressor）
            - fit_params: dict（传给 model.fit，比如 eval_set/early_stopping_rounds/verbose）
    ...
    """
    params = params or {}
    xgb = require_package("xgboost", pip_name="xgboost")
...
if __name__ == "__main__":
    # Mock Data：若未安装 xgboost，会提示安装；若已安装可直接跑通
