...
def solve(data: Any, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    Args:
        ...
        params: 参数：
            ...
            - model_params: dict（传给 RandomForestClassifier/Regressor）
    ...
    return {"model": model, "metrics": metrics, "y_pred": y_pred, "feature_importances": feature_importances}
...
if __name__ == "__main__":
    ...
    y = (X[:, 0] - 0.3 * X[:, 1] + rng.normal(scale=0.2, size=500) > 0).astype(int)
    out = solve((X, y), params={"task": "classification", "model_params": {"n_estimators": 200}})
    print(out["metrics"])
