# -*- coding: utf-8 -*-
# GBDT：Gradient Boosting（sklearn 的 GradientBoostingClassifier/Regressor）
...
def solve(data: Any, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    Args:
        ...
        params: 参数：
            ...
            - model_params: dict（传给 GradientBoostingClassifier/Regressor）
...
if __name__ == "__main__":
    ...
    y = (X[:, 0] + 0.5 * X[:, 2] + rng.normal(scale=0.5, size=500) > 0).astype(int)
