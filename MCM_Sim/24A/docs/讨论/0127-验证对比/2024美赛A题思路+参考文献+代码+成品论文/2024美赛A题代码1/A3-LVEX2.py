...
def extended_lotka_volterra_with_gender(prey_birth_rate, prey_death_rate, predator_birth_rate, predator_death_rate,
    ...
    return time_steps, prey_population, predator_population, lamprey_population, male_ratio
