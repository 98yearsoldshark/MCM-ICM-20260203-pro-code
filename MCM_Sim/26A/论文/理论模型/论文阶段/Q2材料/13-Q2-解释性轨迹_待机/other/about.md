...
- “Show how your model explains differences in these outcomes”  
  用连续时间轨迹展示：SOC(t)、V_term(t)、T(t)、P_total(t) 如何共同决定 TTE。
...
- paper：`MCM_Sim/26A/src/out_plots/q2/paper/trajectories/S0_standby/trace_soc100.png`
- study：`MCM_Sim/26A/src/out_plots/q2/study/trajectories/S0_standby/trace_soc100.png`
