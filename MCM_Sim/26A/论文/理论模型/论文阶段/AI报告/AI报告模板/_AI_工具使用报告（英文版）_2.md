...
 Purpose: <<e.g., Generating structural ideas, polishing expressions, creating pseudo-code frameworks>
...
3. Final Usage: Only referenced the structure; the final model, parameters, and conclusionswere independently developed by the team and are reproducible.
...
 Usage Location: $< < \mathbf { e . g }$ ., simulation.py; optimizer.ipynb>
